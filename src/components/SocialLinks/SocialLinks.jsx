...
const SocialLinks = ({ theme }) => {
    return (
        <div className="text-xl mt-5 mx-auto grid grid-cols-2 sm:grid-cols-4 justify-between md:gap-10 md:col-span-2 ">
            ...
            <a href="https://linkedin.com/in/sakibahmed3" target="_blank" className="">
                <div className="flex gap-2 flex-col items-center bg-white devv-icon p-5 py-3 rounded-lg ">
            ...
            <a href="https://discordapp.com/users/devvsakib" target="_blank" className="">
